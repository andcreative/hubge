# Project: Educational Hub | High School Website

### _Responsive website developed for a educational hub using a template from https://github.com/BuckyMaler/global. Changes made to the code to be in line with the client's brand and ideas. Modifications to the HTML and CSS files for the necessary adjustments. It's not my code, just modified and adapted it._

## Why?

### Project developed at the request of the client. Website approved and working at www.hubge.com.br.
